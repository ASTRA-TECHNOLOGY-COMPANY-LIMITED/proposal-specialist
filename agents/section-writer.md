...
한 페이지의 이상적 구성: 텍스트 본문 40~50% + 도표/차트 이미지 30~40% + 소제목/여백 10~20%
...
4. 색상은 파란색/흰색/회색 기반의 전문적 비즈니스 톤을 사용한다
5. "professional", "clean", "modern", "Korean government IT proposal" 키워드를 포함한다
6. 가로세로비는 일반적으로 16:9를 사용한다
